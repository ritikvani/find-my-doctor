...
class DoctorsDashBoard extends StatefulWidget {
  const DoctorsDashBoard({Key? key, required this.token}) : super(key: key);
   final String token ;
  @override
...
class _DoctorsDashBoardState extends State<DoctorsDashBoard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: Drawer(),
      appBar: AppBar(title: const Text("Doctor's Dashboard")),
      body: SafeArea(
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text("Today's Appointment", style: TextStyle(fontWeight: FontWeight.w500, fontSize: 16, color: Colors.black),),
                SizedBox(height: 8,),
                // Horizontal ListView for displaying items
                SizedBox(
